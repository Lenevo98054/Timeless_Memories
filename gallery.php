...
<head>
    ...
    <title>Gallery | Timeless Photography</title>
    ...
    <section class="gallery-section">
        <div class="container">
            <div class="section-title">
                <h2>Our Gallery</h2>
                <p>Explore our collection of beautiful photographs</p>
            </div>

            <div class="filter-container">
                <select class="filter-select" id="filter" onchange="filterImages()">
            ...
            <div class="gallery-grid" id="gallery">
                ...
                while ($row = $result->fetch_assoc()) {
                    ...
                    <div class="gallery-item" data-category="' . $row['category'] . '">
                        <img src="' . $row['path'] . '" alt="' . $row['name'] . '" class="gallery-img">
